...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 22 13:40:15 2019

@author: https://github.com/IndicoDataSolutions/SuperCell/blob/master/faqs_bot/faqs_bot.py
"""
...
indicoio.config.api_key = "31da1ac659e91bfff5b77d1dd3112479"
...
#    return feat
    ...
    return indicoio.text_features(data)


feats = indicoio.text_features(list(faqs.keys()))
pickle_out = open("faq_feats.pkl","wb")
pickle.dump(feats, pickle_out)
pickle_out.close()
